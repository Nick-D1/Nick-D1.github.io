...
var feedbackRouter = require('./app_server/routes/feedback'); // ✅ keep require here
...
var app = express();  // ✅ app must exist before app.use()
...
app.use('/feedback', feedbackRouter); // ✅ moved down here
